...
setup(
    ...
    description='A reactive debuggable CI-CD & orchestration management tool'
                ' for local & cloud deployments e.g. kubernetes, airflow, data lakes & data science',
    ...
    install_requires=[
        ...
        'ipython', 'ipywidgets', 'pandas', 'Pillow', 'rich', 'pydantic>=2.9.2'
    ],
    keywords=['CI-CD', 'Kubernetes', 'Reactive'],
    entry_points={
        'console_scripts': [
            'wield-git=wielder.scripts.wield_git:main',
        ],
    },
    classifiers=[
