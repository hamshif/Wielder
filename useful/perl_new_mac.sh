...
cpanm  install Test::Kwalitee::Extra --force
...
cpanm  install Pod::Coverage::TrustPod
...
cpanm --interactive --verbose --force --notest Net::SSLeay
...
cpanm install Term::Bash::Completion::Generator
cpanm install Text::Colorizer
cpanm install Data::HexDump::Range

cpanm install Net::Kafka --force
