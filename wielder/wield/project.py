...
from wielder.util.arguer import get_wielder_parser, convert_log_level, parse_known_args_strict
...
def get_bucket_path(conf, relative_path, bucket_name=None):
    if bucket_name is None:
        bucket_name = conf.namespace_bucket

    bucket_path = f'{conf.buckets_root}/{bucket_name}/{relative_path}'
    return bucket_path
