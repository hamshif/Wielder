...
class Locale:
    ...
    def __init__(
            ...
            app_project_root='unknown', app_conf_root='unknown'
    ):
        """
        ...
        :param project_root: The wielder project wrapping delivery of code
        :param super_project_root: The super project containing the wielder project and code projects
        :param super_project_name:
        :param module_root: The local Path to service delivery module
        :param code_repo_name: The local Path to service code module
        :param datastores_root: 3rd party datastore delivery path
        ...
        self.app_project_root = app_project_root
        self.app_conf_root = app_conf_root
